...
export function renderFundamentals() {
  ...
  const columns = [
    ...
    { key: 'roe', label: t('fundamentals.col.roe'), title: 'ROE (TTM) vs sector median — higher is better', align: 'right', render: r => renderRelativePct(r, 'roe', 'sector_median_roe', false) },
